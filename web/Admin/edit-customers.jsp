                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item"><a href="customers.jsp">Khách hàng</a></li>
                                        ...
                                        <div class="tab-pane show active" id="basic-form-preview">
                                            <form action="adminCustomer" method="POST">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" name="address" value="${user.address}" aria-describedby="emailHelp" placeholder="Địa chỉ">
