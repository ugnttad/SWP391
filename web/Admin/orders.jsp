                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item active">Quản lý</a></li>
...
<!--                                        <div class="row mb-2">
                                                ...
                                                <form class="row gy-2 gx-2 align-items-center justify-content-xl-start justify-content-between">
                                                    ...
                                                    <div class="col-auto">
                                                        <div class="d-flex align-items-center">
                                                            <label for="status-select" class="me-2">Lọc</label>
                                                            <select class="form-select" id="status-select">
                                                                <option selected>Tình trạng...</option>
                                                                <option value="1">Đã trả</option>
                                                                <option value="2">Đang xác thực</option>
                                            ...
                                            <table class="table table-centered table-nowrap mb-0">
                                                ...
                                                <tbody>
                                                    <c:forEach items="${orders}" var="order">
                                                        <tr>
                                                            <td class="text-body fw-bold ">${order.orderID}</td>
                                                            <td>
                                                            ...
                                                            <td>
                                                                <c:choose>
                                                                    <c:when test="${order.paymentStatus eq 'Paid'}">
                                                                        <h5><span class="badge badge-success-lighten">${order.paymentStatus}</span></h5>
                                                                            </c:when>
                                                                            <c:when test="${order.paymentStatus eq 'Pending'}">
                                                                        <h5><span class="badge badge-primary-lighten">${order.paymentStatus}</span></h5>
                                                                            </c:when>
                                                                            <c:when test="${order.paymentStatus eq 'failed'}">
                                                                        <h5><span class="badge badge-danger-lighten">${order.paymentStatus}</span></h5>
                                                                            </c:when>
                                                                            <c:otherwise>
                                                                        <!-- Handle default case if needed -->
                                                                        <h5><span class="badge rounded-pill bg-danger">${order.paymentStatus}</span></h5>
                                                                    </c:otherwise>
                                                                </c:choose>
                                                            </td>
                                                            <td>
                                                            ...
                                                            <td>
                                                                <a href="orders-details?id=${order.orderID}" class="action-icon"> <i class="mdi mdi-eye"></i></a>
                                                                <a href="adminOrder?action=edit&orderID=${order.orderID}" class="action-icon"> <i class="mdi mdi-square-edit-outline"></i></a>
                                                                <a href="adminOrder?action=delete&orderID=${order.orderID}" class="action-icon"> <i class="mdi mdi-delete"></i></a>
                                                            </td>
                                                        </tr>
                                                    </c:forEach>
                                                </tbody>
    ...
    <!-- Mirrored from coderthemes.com/hyper/saas/apps-ecommerce-orders.jsp by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 14 Dec 2023 13:30:02 GMT -->
</html>
