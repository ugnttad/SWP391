                            ...
                            <div class="col-lg-7 col-md-10 col-sm-11">
                                <div class="horizontal-steps mt-4 mb-4 pb-5" id="tooltip-container">
                                    <div class="horizontal-steps-content">
                                        <c:set var="status" value="${lists[0].deliveryStatus}" />

                                        <div class="step-item ${status == 'Cancelled' ? 'current' : (status == 'Waiting' || status == 'Processing' || status == 'Delivered' ? 'completed' : '')}">
                                            <span data-bs-container="#tooltip-container" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Cancelled">Cancelled</span>
                                        </div>

                                        <div class="step-item ${status == 'Watting' ? 'current' : (status == 'Processing' || status == 'Delivered' ? 'completed' : '')}">
                                            <span data-bs-container="#tooltip-container" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Waiting">Waiting</span>
                                        </div>

                                        <div class="step-item ${status == 'Processing' ? 'current' : (status == 'Delivered' ? 'completed' : '')}">
                                        ...
                                        <div class="step-item ${status == 'Delivered' ? 'current' : ''}">
                                            <span>Delivered</span>
                                        </div>
                                    </div>

                                    <div class="process-line" style="width: ${status == 'Delivered' ? '100%' : (status == 'Processing' ? '66.6%' : (status == 'Watting' ? '33.3%' : (status == 'Cancelled' ? '0%' : '0%')))};"></div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-lg-4">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <h5>${lists[0].nameOrder}</h5>

                                        <address class="mb-0 font-14 address-lg">
                                            ${lists[0].deliveryLocation}<br/>
                                            <abbr title="Phone">Phone: </abbr>${lists[0].phone} <br/>
                                        </address>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="text-center">
                                            ...
                                            <h5><b>Giaohangtietkiem</b></h5>
                                            <c:set var="isPrinted" value="false"/>
                                            <c:forEach var="o" items="${lists}">
                                                <c:if test="${isPrinted eq 'false'}">
                                                    <p class="mb-1"><b>Order ID :</b> ${o.orderID}</p>
                                                    <c:set var="isPrinted" value="true"/>
                                                    <p class="mb-0"><b>Payment Method :</b> COD</p>
                                                </c:if>
                                            </c:forEach>
                                        </div>
                                    </div>
