                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item active"><a href="#">Lịch trình</a></li>
                                        </ol>
                                    </div>
                                            ...
                                            <div class="col-lg-3">
                                                <div class="d-grid">
                                                    <button class="btn btn-lg font-16 btn-danger" id="btn-new-event">
                                                        <i class="mdi mdi-plus-circle-outline"></i> Tạo sự kiện mới
                                                    </button>
                                                </div>
                                                <div id="external-events" class="mt-3">
                                                    <p class="text-muted">Kéo thả sự kiện hoặc nhấn vào lịch của bạn!</p>
                                                    <div class="external-event bg-success-lighten text-success" data-class="bg-success"><i class="mdi mdi-checkbox-blank-circle me-2 vertical-middle"></i>Hoàn thành</div>
                                                    <div class="external-event bg-info-lighten text-info" data-class="bg-info"><i class="mdi mdi-checkbox-blank-circle me-2 vertical-middle"></i>Đang diễn ra</div>
                                                    <div class="external-event bg-warning-lighten text-warning" data-class="bg-warning"><i class="mdi mdi-checkbox-blank-circle me-2 vertical-middle"></i>Sắp diễn ra</div>
                                                    <div class="external-event bg-danger-lighten text-danger" data-class="bg-danger"><i class="mdi mdi-checkbox-blank-circle me-2 vertical-middle"></i>Chưa thực hiện</div>
                                                </div>
                                            ...
                                            <form class="needs-validation" name="event-form" id="form-event" novalidate>
                                                ...
                                                <div class="modal-body px-4 pb-4 pt-0">
                                                    <div class="row">
                                                        <div class="col-12">
                                                            <div class="mb-3">
                                                                <label class="control-label form-label">Tên sự kiện</label>
                                                                <input class="form-control" placeholder="Insert Event Name" type="text" name="title" id="event-title" required />
                                                                <div class="invalid-feedback">Tên không hợp lệ. Hãy nhập lại!</div>
                                                            </div>
                                                        </div>
                                                        <div class="col-12">
                                                            <div class="mb-3">
                                                                <label class="control-label form-label">Danh mục</label>
                                                                <select class="form-select" name="category" id="event-category" required>
                                                                    <option value="bg-danger" selected>Chưa thực hiện</option>
                                                                    <option value="bg-success">Đã hoàn thành</option>
                                                                    <option value="bg-info">Đang diễn ra</option>
                                                                    <option value="bg-warning">Sắp diễn ra</option>
                                                                </select>
                                                                <div class="invalid-feedback">Vui lòng chọn 1 danh sách hợp lệ!</div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-6">
                                                            <button type="button" class="btn btn-danger" id="btn-delete-event">Xoá</button>
                                                        </div>
                                                        <div class="col-6 text-end">
                                                            <button type="button" class="btn btn-light me-1" data-bs-dismiss="modal">Đóng</button>
                                                            <button type="submit" class="btn btn-success" id="btn-save-event">Lưu</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </form>
...
<!-- Mirrored from coderthemes.com/hyper/saas/apps-calendar.jsp by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 14 Dec 2023 13:29:54 GMT -->
</html>