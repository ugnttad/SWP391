...
<html>
    ...
    <body>
        ...
        <main class="content--padding">
            ...
            <div class="content_page">
                <div class="content">
                    <!-- Start Content-->
                    <div class="container-fluid">
                        <h3 style="text-align: center; color: red;">Trạng thái đơn hàng của bạn</h3> <br>
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                            ...
                                            <div class="col-md-12">
                                                <div class="table-responsive">
                                                    <table class="table table-borderless table-nowrap table-centered mb-0">
                                                        ...
                                                        <tbody>
                                                            <c:choose>
                                                                <c:when test="${not empty allDonHang}">
                                                                    <c:forEach var="cartItem" items="${allDonHang}">
                                                                        <tr class="product">
                                                                            <td>
                                                                            ...
                                                                            <td>
                                                                                <span class="thanhTien">${cartItem.thanhTien}đ</span>
                                                                            </td>
                                                                            <td>
                                                                                <span class="paymentStatus">${cartItem.paymentStatus}</span>
                                                                            </td>
                                                                            <td>
                                                                                <span class="deliveryStatus">${cartItem.deliveryStatus}</span>
                                                                            </td>
                                                                            <td style="padding-top:27px;">
                                                                                <span class="paymentType">${cartItem.paymentType}</span>
                                                                            </td>
                                                                            <td>
                                                                                <input type="date" name="orderDate" value="${cartItem.orderDate}" disabled>
                                                                            </td>
                                                                ...
                                                                <c:otherwise>
                                                                <p>Không có đơn hàng nào đang được giao đến bạn!</p>
                                                            </c:otherwise>
                                                        </c:choose>
                                                        </tbody>
                                                    </table>
                                                    ...
                                                    <div class="col-sm-6">
                                                        <a href="shopping"
                                                           class="btn text-muted d-none text-decoration-none d-sm-inline-block btn-link fw-semibold">
                                                            <i class="fas fa-arrow-left"></i> Trở về giỏ hàng </a>
                                                    </div> <!-- end col -->
                                                    <div class="col-sm-6">
                                                                ...
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-header">
                                                                        <h4 class="modal-title">
                                                                            ...
                                                                            <i class="fas fa-map-marker-alt" style="color: red;"> Xác nhận thông tin đơn
                                                                                hàng</i>
                                                                        </h4>
                                                                    ...
                                                                    <div class="row ms-4 ps-5">
                                                                        <div class="modal-body align-items-center">
                                                                            <c:forEach var="customer" items="${allCus}" begin="1" end ="2">
                                                                                    ...
                                                                                    <table>
                                                                                        ...
                                                                                        <tr>
                                                                                            <td class="pb-2 user_info">
                                                                                                <textarea name="address" id="address" placeholder="Địa Chỉ Nhận Hàng" cols="40">${customer.address}</textarea>
                                                                                            </td>
                                                                                        </tr>
        ...
        <!--        <script>
                    ...
                    function displayOk() {
                        let form = document.querySelector(".ok");
